...
plot.lambda <- FeaturePlot(SeuratObj, features = "IgLight-chain-lamda", reduction = "Ibex.L.KF") + 
                  scale_color_viridis() + 
                  ylab("Ibex_LC_2") + 
                  xlab("Ibex_LC_1") + 
                  theme_void() + 
...
plot.kappa <- FeaturePlot(SeuratObj, features = "IgLight-chain-kappa", reduction = "Ibex.L.KF") + 
                  scale_color_viridis() + 
                  ylab("Ibex_LC_2") + 
                  xlab("Ibex_LC_1") + 
                  theme_void() +
...
plot.lambda + plot.kappa + plot_layout(ncol = 1)
```
