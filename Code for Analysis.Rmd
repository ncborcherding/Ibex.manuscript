...
heavy.plot.V <- DimPlot(seurat.merge[,cells], reduction = "Ibex.H.KF", group.by = "Heavy.V") + 
                  scale_color_viridis(discrete = TRUE) + 
                  theme_void() + 
                  guides(fill = "none") + 
...
DimPlot(seurat.merge[,cells], reduction = "Ibex.H.KF", group.by = "orig.ident") + 
                  scale_color_viridis(discrete = TRUE) + 
                  theme_void() + 
                  guides(fill = "none") + 
                  theme(plot.title = element_blank()) +
...
light.plot.V <- DimPlot(seurat.merge, reduction = "Ibex.L.KF", group.by = "Light.V") + 
                  scale_color_viridis(discrete = TRUE) + 
                  theme_void() + 
                  guides(fill = "none") + 
                  theme(plot.title = element_blank()) +
...
DimPlot(seurat.merge[,cells], reduction = "Ibex.L.KF", group.by = "orig.ident") + 
                  scale_color_viridis(discrete = TRUE) + 
                  theme_void() + 
                  guides(fill = "none") + 
                  theme(plot.title = element_blank()) +
...
heavy.plot.Cl <-DimPlot(seurat.merge[,cells], reduction = "Ibex.H.KF", group.by = "Heavy.group") + 
                      scale_color_viridis(discrete = TRUE, option = "H", na.value = "grey") + 
                      theme_void() + 
                      theme(plot.title = element_blank()) 
