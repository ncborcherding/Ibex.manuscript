...
lapply(tmp.list, function(x) {
  findElbowPoint(x[,"value"], -log10(as.numeric(x[,"score"])))
}) -> elbow.point.list
...
ggsave("./outputs/Figure1/Figure1C.pdf", height = 7, width = 6)
...
plot1 + plot2 + plot_layout(guides = "collect", ncol = 1)
ggsave("./outputs/Figure1/Figure1E.pdf", height = 7, width = 6)
```
...
plot1 + plot2 + plot3 + plot_layout(ncol = 1, guides = "collect")
