...
FeaturePlot(SeuratMerge, rownames(SeuratMerge@assays$BEAM$counts)[c(2,11)])
```
...
for(i in seq_along(SC.Files)) {
  ...
  write.csv(tmp, paste0("./data/Benisse/inputs/", SC.Files[i], "_contigs.csv"))
}


```

#Format \_exp.csv rows: genes, columns = names
