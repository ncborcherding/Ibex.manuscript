...
reductions <- names(SeuratMerge@reductions)[4:9]
...
output <- rescaleByNeighbors(
                  list(SeuratMerge[["Ibex.H.VAE.KF"]]@cell.embeddings, 
...
```{r}
saveRDS(SeuratMerge, "~/data/SeuratMerge.rds")
```
